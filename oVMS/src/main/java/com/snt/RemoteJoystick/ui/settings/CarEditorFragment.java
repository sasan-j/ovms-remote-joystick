package com.snt.RemoteJoystick.ui.settings;
...
import com.snt.RemoteJoystick.ui.validators.PasswdValidator;
import com.snt.RemoteJoystick.ui.validators.StringValidator;
import com.snt.RemoteJoystick.ui.validators.ValidationException;
...
public class CarEditorFragment extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((ActionBarActivity)getActivity()).getSupportActionBar().setIcon(R.drawable.ic_action_edit);
...
//			return true;
	...
	private void approveCarData() {
		View rootView = getView();
		getActivity().setTitle(mCarData.sel_vehicleid);
